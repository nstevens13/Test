...
@Component({
  selector: 'app-surveyinventory',
  templateUrl: './surveyinventory.component.html',
  styleUrls: ['./surveyinventory.component.css']
})
export class SurveyinventoryComponent implements OnInit, AfterContentInit {
    ...
    this.getSectionInfo.getSectionData().subscribe((sectionArray: {}) => {
      this.getSurveyInfo.getSurveyData().subscribe((surveyArray: {}) => {
        ...
        this.inventoryData.sort((obj1, obj2) => {
          if (obj1.SurveyName > obj2.SurveyName) {
            return 1;
          }
